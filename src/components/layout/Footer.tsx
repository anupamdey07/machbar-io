                            ...
                            {socialLinks.map((social) => (
                                ...
                                >
                                    ...
                                    {social.name === 'Hugging Face' && (
                                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clipRule="evenodd" d="M12 0h.01c.2 0 1.93.34 3.31 1.35.7.43 2.14 2 2.45 4.31.02.26 0 .5-.05.74-.25.59-.14 1-.22 1.34-1.07.61-1.05 1.58-.8 2.6.25 1.02.82 1.63 1.76 1.63s1.7-.61 2.37-1.39c.61-1.23 1.18-2.9 1.18-4.72 0-2.31-1.32-4.44-3.32-5.45C17.03.04 14.57-.16 12.01 0h-.01c-2.56.16-5.02.04-6.68.46C3.33.47 2.01 2.6 2.01 4.91c0 1.82.57 3.49 1.18 4.72.67.78 1.43 1.39 2.37 1.39s1.51-.61 1.76-1.63c.25-1.02.27-1.99-.8-2.6-.08-.34.03-.75-.22-1.34-.05-.24-.07-.48-.05-.74.31-2.31 1.75-3.88 2.45-4.31 1.38-1.01 3.11-1.34 3.3-1.35zM9.25 3c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm5.5 0c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-2.75 6.5s-.37 1.5-2 1.5h4c-1.63 0-2-1.5-2-1.5z" />
                                        </svg>
                                    )}
                                    {social.name === 'Discord' && (
                                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
